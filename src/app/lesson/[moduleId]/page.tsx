    ...
    <AppShell fullWidth>
      ...
      <section className="grid gap-6 lg:grid-cols-[320px_minmax(0,1fr)]">
        ...
        <div className="space-y-4">
          <LessonAccessGate modules={modules} moduleId={module.id}>
              ...
              {markdown ? (
                ...
                <div className="space-y-4">
                  ...
                  <p className="rounded-md border bg-muted/50 p-4 text-sm">
                    This module is mapped for the full curriculum. Add a
                    markdown file in <code>content/lessons/{module.lesson}</code>{" "}
                    to seed the complete lesson.
                  </p>
                </div>
              )}
            </div>
